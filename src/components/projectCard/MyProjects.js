      ...
      <div className="project-container">
        <div className="project-card">
          ...
          <div className="pro-details">
            <p>
              Team project to help people to report or found their pet.
              Techniques used: HTML5, CSS3, JavaScript, Bootstrap,
              Express-handlebars, MySQL2, Sequelize, dotenv, Node.js,
              cloudinary, bcrypt, express-session, connect-session-sequelize
            </p>
